  ...
  if (req.method === "POST") {
    ...
    try {
      await transporter.sendMail({
        from: "suvinjavax@gmail.com",
        to: "rediantsparktechnology@gmail.com",
        subject: "Invoice Details",
        text: "Prestige auto care order completed",
        html: `<html>
        <head>
        ...
        </script><script src="https://cdnjs.cloudflare.com/ajax/libs/twitter-bootstrap/4.3.1/js/bootstrap.min.js">
        </body>
        </html>`,
      });
