...
!(function (t, e) {
      ...
      return (
        ...
        (s._setActiveIndicatorElement = function (t) {
          if (this._indicatorsElement) {
            for (
              var e = q.find(".active", this._indicatorsElement), i = 0;
              i < e.length;
              i++
            )
  ...
  j.on(
    ...
    j.on(window, "load.bs.carousel.data-api", function () {
      for (
        var t = q.find('[data-bs-ride="carousel"]'), e = 0, i = t.length;
        e < i;
        e++
      )
        K.carouselInterface(t[e], T(t[e], "bs.carousel"));
    }),
    b(function () {
      var t = y();
      if (t) {
  ...
  function kt(t) {
    for (var e = ct(t), i = wt(t); i && yt(i) && "static" === vt(i).position; )
      i = wt(i);
    return i && "body" === dt(i) && "static" === vt(i).position
      ? e
      : i ||
          (function (t) {
            for (
              var e = _t(t);
              ht(e) && ["html", "body"].indexOf(dt(e)) < 0;
  ...
  function Et(t) {
    ...
    if (l) {
      ...
      v === ct(i) && (v = bt(i)),
        ...
        o === ot &&
          ((p = nt), (c -= v.clientWidth - n.width), (c *= a ? 1 : -1));
    }
    var y,
      b = Object.assign({ position: r }, l && Ot);
    return a
      ? Object.assign(
          Object.assign({}, b),
          {},
  ...
  function Ut(t, e) {
    ...
    var i = e,
      ...
      w = jt(v),
      k = qt({ reference: w, element: y, strategy: "absolute", placement: o }),
        ...
        (("body" !== dt(e) || Ft(s)) &&
          (l =
            (n = e) !== ct(n) && ht(n)
              ...
              : Ht(n)),
        ht(e)
          ? (((d = jt(e)).x += e.clientLeft), (d.y += e.clientTop))
          : s && (d.x = $t(s))),
      {
            ...
            return (
              ...
              a.orderedModifiers.forEach(function (t) {
                ...
                if ("function" == typeof o) {
                  var s = o({ state: a, name: e, instance: c, options: n });
                  l.push(s || function () {});
                }
              }),
              c.update()
  ...
  var oe = ne(),
    se = ne({ defaultModifiers: [It, Xt, Mt, ft] }),
    re = ne({ defaultModifiers: [It, Xt, Mt, ft, Gt, Vt, Zt, Dt, Kt] }),
    ae = Object.freeze({
      __proto__: null,
      popperGenerator: ne,
      detectOverflow: Ut,
    ...
    we = (function (t) {
      function o(e, i) {
        ...
        return (
          ...
          (n._dialog = q.findOne(".modal-dialog", e)),
          (n._backdrop = null),
          (n._isShown = !1),
          ...
          if (this._isBodyOverflowing) {
            q
              ...
              .forEach(function (e) {
                ...
                Y.setDataAttribute(e, "padding-right", i),
              ...
              q.find(".sticky-top").forEach(function (e) {
                ...
                Y.setDataAttribute(e, "margin-right", i),
                  (e.style.marginRight =
                    Number.parseFloat(n) - t._scrollbarWidth + "px");
              });
          ...
          l.forEach(function (t) {
            (function (t, e) {
              ...
              if (e.includes(i))
                return (
                  !ke.has(i) ||
                  Boolean(t.nodeValue.match(Te) || t.nodeValue.match(xe))
                );
              for (
      ...
      return (
        ...
        (s._getConfig = function (t) {
          ...
          return (
            ...
            p(Ce, t, this.constructor.DefaultType),
            t.sanitize &&
  ...
  var Le = "popover",
    ...
    je = i({}, Pe.DefaultType, { content: "(string|element|function)" }),
    He = {
  ...
  b(function () {
    ...
    if (t) {
      var e = t.fn[Le];
      (t.fn[Le] = $e.jQueryInterface),
        (t.fn[Le].Constructor = $e),
        (t.fn[Le].noConflict = function () {
    ...
    Be = (function (t) {
      ...
      return (
        ...
        (s._getConfig = function (t) {
          if (
            "string" !=
              typeof (t = i({}, Ne, "object" == typeof t && t ? t : {}))
                .target &&
            h(t.target)
          ) {
            var e = t.target.id;
        ...
        (s._activate = function (t) {
          ...
          i.classList.contains("dropdown-item")
            ...
            : (i.classList.add("active"),
              q.parents(i, ".nav, .list-group").forEach(function (t) {
  ...
  var qe = { animation: "boolean", autohide: "boolean", delay: "number" },
          ...
          if (1 == r.length) this.arcFill = r[0];
            ...
            for (
              var a = n.gradientAngle || 0,
                ...
                d = o.createLinearGradient.apply(o, l),
                c = 0;
              c < r.length;
              c++
            ) {
  ...
  (function (t, e) {
    ...
    function n(t, e, o) {
      ...
      var s,
        d = t;
      return (
        "string" == typeof t && (d = document.querySelectorAll(t)),
        d
          ? ((this.elements =
              ((s = d),
              Array.isArray(s)
          ...
          : void a.error("Bad element for imagesLoaded " + (d || t))
      );
    }
    function o(t) {
      this.img = t;
      ...
      (t.widget = function (e, i, n) {
        ...
        return (
          ...
          (s.prototype = t.widget.extend(
            ...
            a,
            { constructor: s, namespace: l, widgetName: e, widgetFullName: d }
          )),
          o
    ...
    (t = function (t, e) {
      ...
      (i = function (t) {
        ...
        for (t = t || {}, e = 1; e < arguments.length; e++)
          if ((n = arguments[e]))
            for (var o in n)
              n.hasOwnProperty(o) &&
                ("object" == typeof n[o] ? i(t[o], n[o]) : (t[o] = n[o]));
        return t;
      }),
      (n = function (t, e) {
        for (var i = 0; i < e.length; i++)
      ...
      ((DateFormatter = function (t) {
        ...
        getMonth: function (t) {
          var e;
          return (
            0 === (e = n(t, this.dateSettings.monthsShort) + 1) &&
              (e = n(t, this.dateSettings.months) + 1),
            e
          );
        },
        parseDate: function (e, i) {
          ...
          for (
            o = e.replace(f.separators, "\0").split("\0"), s = 0;
            s < o.length;
            s++
          )
            switch (((r = o[s]), (a = parseInt(r)), n[s])) {
              ...
              case "h":
                if (
                  ...
                  (c = t(h, g.meridiem[0]) ? 0 : t(h, g.meridiem[1]) ? 12 : -1),
                    1 <= a && a <= 12 && -1 < c
                      ? (v.hour = a + c - 1)
                      : 0 <= a && a <= 23 && (v.hour = a);
                else {
  ...
  var e = {
    ...
    r = function () {
      ...
      "function" == typeof DateFormatter &&
        (i = n = new DateFormatter({ dateSettings: t.extend({}, s, a) }));
    },
    a = {
      moment: {
        default_options: {
          ...
          ? (t(this).hasClass("xdsoft_scroller_box") ||
              ...
              (v = function (t) {
                ...
                e < 0 && (e = 0),
                  ...
                  l.trigger("scroll_element.xdsoft_scroller", [c ? e / c : 0]);
              }),
              a
                .on(
                  ...
                  function (n) {
                    o || l.trigger("resize_scroll.xdsoft_scroller", [i]),
                      ...
                      "mousedown" === n.type || "touchstart" === n.type
                        ? (e.ownerDocument &&
                            t(e.ownerDocument.body).addClass("xdsoft_noselect"),
                          t([e.ownerDocument.body, e.contentWindow]).on(
                            "touchend mouseup.xdsoft_scroller",
                            function i() {
                              t([e.ownerDocument.body, e.contentWindow])
                                .off("touchend mouseup.xdsoft_scroller", i)
                                .off("mousemove.xdsoft_scroller", v)
                                .removeClass("xdsoft_noselect");
                            }
                          ),
                          t(e.ownerDocument.body).on(
              ...
              l
                .on("scroll_element.xdsoft_scroller", function (t, e) {
                  o || l.trigger("resize_scroll.xdsoft_scroller", [e, !0]),
                    ...
                    a.css("margin-top", c * e),
                    setTimeout(function () {
                      n.css(
                        "marginTop",
                        -parseInt((n[0].offsetHeight - o) * e, 10)
                      );
                    }, 10);
                })
              ...
              l.on("mousewheel", function (t) {
                ...
                return (
                  (e -= 20 * t.deltaY) < 0 && (e = 0),
                  l.trigger("scroll_element.xdsoft_scroller", [e / (s - o)]),
                  t.stopPropagation(),
                  !1
                );
              }),
      ...
      return (
        (r = function (e) {
          var s,
            ...
            C,
            D,
            O = t('<div class="xdsoft_datetimepicker xdsoft_noselect"></div>'),
            E = t(
            ...
            return (
              S.startDate
                ...
                : S.defaultDate &&
                  ...
                  S.defaultTime &&
                    ((t = C.strtotime(S.defaultTime)),
                    i.setHours(t.getHours()),
                    i.setMinutes(t.getMinutes()))),
                ...
                if (
                  !(t =
                    "string" == typeof t || t instanceof String
                      ? n.ownerDocument.getElementById(t)
                      : t)
                )
                  return !1;
              ...
              !0 === n.mask &&
                (i.formatMask
                  ...
                  : (n.mask = n.format
                      ...
                      .replace(/i/g, "59")
                      .replace(/s/g, "59"))),
              "string" === t.type(n.mask) &&
                (o(n.mask, e.val()) ||
                  (e.val(n.mask.replace(/[0-9]/g, "_")), s(e[0], 0)),
                e.on("paste.xdsoft", function (i) {
                  var r = (
                      i.clipboardData ||
          ...
          A.find(".xdsoft_select")
            ...
            .on("touchend mousedown.xdsoft", ".xdsoft_option", function () {
              if (!this.touchMoved) {
                ...
                C &&
                  C.currentTime &&
                  C.currentTime[
                    t(this).parent().parent().hasClass("xdsoft_monthselect")
                      ? "setMonth"
                      : "setFullYear"
                  ](t(this).data("value")),
                  ...
                  e !== C.currentTime.getFullYear() &&
                    t.isFunction(S.onChangeYear) &&
            ...
            (O.setOptions = function (n) {
              ...
              (S = t.extend(!0, {}, S, n)),
                n.allowTimes &&
                  t.isArray(n.allowTimes) &&
                  n.allowTimes.length &&
                  (S.allowTimes = t.extend(!0, [], n.allowTimes)),
                n.weekends &&
                  t.isArray(n.weekends) &&
                  n.weekends.length &&
                  (S.weekends = t.extend(!0, [], n.weekends)),
                n.allowDates &&
                  t.isArray(n.allowDates) &&
                  n.allowDates.length &&
                  (S.allowDates = t.extend(!0, [], n.allowDates)),
                n.allowDateRe &&
                  "[object String]" ===
                    Object.prototype.toString.call(n.allowDateRe) &&
                  (S.allowDateRe = new RegExp(n.allowDateRe)),
                n.highlightedDates &&
                  t.isArray(n.highlightedDates) &&
                  n.highlightedDates.length &&
                  (t.each(n.highlightedDates, function (e, n) {
                    var s,
                      r = t.map(n.split(","), t.trim),
                ...
                n.highlightedPeriods &&
                  ...
                  (S.highlightedDates = t.extend(!0, [], o))),
                n.disabledDates &&
                  t.isArray(n.disabledDates) &&
                  n.disabledDates.length &&
                  (S.disabledDates = t.extend(!0, [], n.disabledDates)),
                n.disabledWeekDays &&
                  t.isArray(n.disabledWeekDays) &&
                  n.disabledWeekDays.length &&
                  (S.disabledWeekDays = t.extend(!0, [], n.disabledWeekDays)),
                (!S.open && !S.opened) || S.inline || e.trigger("open.xdsoft"),
                S.inline &&
                  (($ = !0), O.addClass("xdsoft_inline"), e.after(O).hide()),
                S.inverseButton &&
                  ((S.next = "xdsoft_prev"), (S.prev = "xdsoft_next")),
                S.datepicker ? M.addClass("active") : M.removeClass("active"),
                S.timepicker ? P.addClass("active") : P.removeClass("active"),
                S.value &&
                  (C.setCurrentTime(S.value), e && e.val && e.val(C.str)),
                isNaN(S.dayOfWeekStart)
                  ? (S.dayOfWeekStart = 0)
                  : (S.dayOfWeekStart = parseInt(S.dayOfWeekStart, 10) % 7),
                S.timepickerScrollbar || L.xdsoftScroller(S, "hide"),
                S.minDate &&
                  /^[\+\-](.*)$/.test(S.minDate) &&
                ...
                S.validateOnBlur &&
                  e.off("blur.xdsoft").on("blur.xdsoft", function () {
                    if (
                      ...
                      t(this).val(null), O.data("xdsoft_datetime").empty();
                    else {
                      ...
                      if (e) t(this).val(i.formatDate(e, S.format));
                        ...
                        o < 60
                          ...
                          : t(this).val(i.formatDate(C.now(), S.format));
                      }
            ...
            S.insideParent ? t(e).parent().append(O) : t(S.parentID).append(O),
            (C = new (function () {
              var e = this;
              (e.now = function (t) {
                var i,
                ...
                return (
                  !t &&
                    S.defaultDate &&
                    ((i = e.strToDateTime(S.defaultDate)),
                ...
                (e.setCurrentTime = function (t, i) {
                  "string" == typeof t
                    ? (e.currentTime = e.strToDateTime(t))
                    : e.isValidDate(t)
                    ? (e.currentTime = t)
                    : t || i || !S.allowBlank || S.inline
                    ? (e.currentTime = e.now())
                    : (e.currentTime = null),
                    O.trigger("xchange.xdsoft");
                }),
                ...
                (e.nextMonth = function () {
                  (void 0 !== e.currentTime && null !== e.currentTime) ||
                    (e.currentTime = e.now());
                  var i,
                    n = e.currentTime.getMonth() + 1;
                  return (
                    12 === n &&
                      (e.currentTime.setFullYear(
                        e.currentTime.getFullYear() + 1
                      ),
                      (n = 0)),
                    (i = e.currentTime.getFullYear()),
                    e.currentTime.setDate(
                      Math.min(
                        new Date(
                          e.currentTime.getFullYear(),
                          n + 1,
                          0
                        ).getDate(),
                        e.currentTime.getDate()
                      )
                    ),
                ...
                (e.getWeekOfYear = function (e) {
                  ...
                  return (
                    ...
                    Math.ceil(((e - n) / 864e5 + n.getDay() + 1) / 7)
                  );
                }),
                      ...
                      (o =
                        s && s[2]
                          ? ((n =
                            ...
                            new Date(
                              e.now(!0).getTime() + parseInt(s[1] + "1", 10) * n
                            ))
                          : t
                          ? i.parseDate(t, S.format)
                          : e.now()),
                ...
                (e.str = function () {
                  ...
                  return (
                    S.yearOffset &&
                      (t = (t = t.replace(
                        "Y",
                        e.currentTime.getFullYear() + S.yearOffset
                      )).replace(
                        "y",
                        String(
                          e.currentTime.getFullYear() + S.yearOffset
            ...
            A.find(".xdsoft_prev,.xdsoft_next").on(
              ...
              function () {
                ...
                !(function t(o) {
                  e.hasClass(S.next)
                    ? C.nextMonth()
                    : e.hasClass(S.prev) && C.prevMonth(),
                    S.monthChangeSpinner &&
                      (n || (i = setTimeout(t, o || 100)));
                })(500),
                  t([S.ownerDocument.body, S.contentWindow]).on(
                    "touchend mouseup.xdsoft",
                    function e() {
                      clearTimeout(i),
                        (n = !0),
                        t([S.ownerDocument.body, S.contentWindow]).off(
                          "touchend mouseup.xdsoft",
                          e
                        );
                    }
            ...
            O.on("xchange.xdsoft", function (r) {
                ...
                (s = setTimeout(function () {
                  ...
                  for (
                    ...
                    (T = []),
                      ...
                      T.push("xdsoft_date"),
                      (u =
                        S.beforeShowDay && t.isFunction(S.beforeShowDay.call)
                    ...
                    ((!1 !== b && b < g) ||
                      ...
                      -1 !== S.disabledWeekDays.indexOf(a) &&
                        T.push("xdsoft_disabled"),
                      e.is("[disabled]") && T.push("xdsoft_disabled"),
                      u && "" !== u[1] && T.push(u[1]),
                  ...
                  if (
                    (!1 !== S.maxTime &&
                      ((P = C.strtotime(S.maxTime)),
                      (L = 60 * P.getHours() + P.getMinutes())),
                    !1 !== S.minDateTime &&
                      ((P = C.strToDateTime(S.minDateTime)),
                      i.formatDate(C.currentTime, S.formatDate) ===
                        i.formatDate(P, S.formatDate)))
                  ) {
                  ...
                  if (
                    (!1 !== S.maxDateTime &&
                      ((P = C.strToDateTime(S.maxDateTime)),
                      i.formatDate(C.currentTime, S.formatDate) ===
                        i.formatDate(P, S.formatDate) &&
                        (W = 60 * P.getHours() + P.getMinutes()) < L &&
                        (L = W)),
                    (h = function (n, o) {
                      var s,
                        r = C.now(),
                    ...
                    for (v = 0; v < S.allowTimes.length; v += 1)
                      h(
                        ...
                        (W = C.strtotime(S.allowTimes[v]).getMinutes())
                      );
                  else
              ...
              S.timepicker &&
                ...
                t
                  ? ((e = L[0].clientHeight),
                    (i = z[0].offsetHeight) - e <
                      (n = z.find(t).index() * S.timeHeightInTimePicker + 1) &&
                      (n = i - e),
                    L.trigger("scroll_element.xdsoft_scroller", [
                      parseInt(n, 10) / (i - e),
                    ]))
              ...
              .on("touchend click.xdsoft", "div", function (e) {
                if (!this.touchMoved) {
                  ...
                  n.setHours(i.data("hour")),
                    ...
                    S.onSelectTime &&
                      t.isFunction(S.onSelectTime) &&
                      S.onSelectTime.call(O, C.currentTime, O.data("input"), e),
                    O.data("changed", !0),
                    O.trigger("xchange.xdsoft"),
                    O.trigger("changedatetime.xdsoft"),
                    !0 !== S.inline &&
            ...
            M.on("mousewheel.xdsoft", function (t) {
              return (
                !S.scrollMonth ||
                (t.deltaY < 0 ? C.nextMonth() : C.prevMonth(), !1)
              );
            }),
                ...
                (!S.datepicker && S.timepicker
                  ? (0 <=
                      (a = z.find(".xdsoft_current").length
                        ...
                        : 0) +
                        t.deltaY &&
                      a + t.deltaY < z.children().length &&
                      (a += t.deltaY),
                    z.children().eq(a).length &&
                      z.children().eq(a).trigger("mousedown"),
                    !1)
                  : S.datepicker && !S.timepicker
                  ? (M.trigger(t, [t.deltaY, t.deltaX, t.deltaY]),
                    e.val && e.val(C.str()),
                    O.trigger("changedatetime.xdsoft"),
                    !1)
                  : void 0)
            ...
            O.on("changedatetime.xdsoft", function (e) {
              if (S.onChangeDateTime && t.isFunction(S.onChangeDateTime)) {
                var i = O.data("input");
                S.onChangeDateTime.call(O, C.currentTime, i, e),
                  delete S.value,
                  i.trigger("change");
              }
            })
              .on("generate.xdsoft", function () {
                S.onGenerate &&
                  t.isFunction(S.onGenerate) &&
                  S.onGenerate.call(O, C.currentTime, O.data("input")),
                  $ && (O.trigger("afterOpen.xdsoft"), ($ = !1));
              })
            ...
            (l = function () {
              ...
              if (
                ((e = (l = O.data("input")).offset()),
                (i = l[0]),
                (c = "top"),
                (n = e.top + i.offsetHeight - 1),
                (o = e.left),
                (s = "absolute"),
                (d = t(S.contentWindow).width()),
                (h = t(S.contentWindow).height()),
                (f = t(S.contentWindow).scrollTop()),
                S.ownerDocument.documentElement.clientWidth - e.left <
              ...
              "rtl" === l.parent().css("direction") &&
                ...
                S.fixed
                  ? ((n -= f),
                    (o -= t(S.contentWindow).scrollLeft()),
                    (s = "fixed"))
                  : ((a = !1),
                    D(i, function (t) {
                      return (
                    ...
                    a && !S.insideParent
                      ? ((s = "fixed"),
                        n + O.outerHeight() > h + f
                          ? ((c = "bottom"), (n = h + f - e.top))
                          : (n -= f))
                      : n + O[0].offsetHeight > h + f &&
                        (n = e.top - O[0].offsetHeight + 1),
                    n < 0 && (n = 0),
            ...
            O.on("open.xdsoft", function (e) {
              var i = !0;
              S.onShow &&
                t.isFunction(S.onShow) &&
                (i = S.onShow.call(O, C.currentTime, O.data("input"), e)),
                !1 !== i &&
                  (O.show(),
                  l(),
                  t(S.contentWindow)
              ...
              .on("close.xdsoft", function (e) {
                ...
                A.find(".xdsoft_month,.xdsoft_year")
                  ...
                  .hide(),
                  S.onClose &&
                    t.isFunction(S.onClose) &&
                    (i = S.onClose.call(O, C.currentTime, O.data("input"), e)),
            ...
            e
              ...
              .on(
                ...
                function () {
                  e.is(":disabled") ||
                    (e.data("xdsoft_datetimepicker").is(":visible") &&
                      S.closeOnInputClick) ||
                    (S.openOnFocus &&
                      (clearTimeout(F),
        ...
        (a = function (e) {
          ...
          i &&
            ...
            t([S.contentWindow, S.ownerDocument.body]).off(
                  ...
                  function t() {
                    e.is(":disabled") ||
                      ...
                      (C = setTimeout(function () {
                        e.data("xdsoft_datetimepicker") || r(e),
                          e
                            .off(
                              "open.xdsoft focusin.xdsoft mousedown.xdsoft touchstart",
                              t
...
!(function (t) {
  "function" == typeof define && define.amd
    ? define(["jquery", "jquery-mousewheel"], t)
    : "object" == typeof exports
          ...
          if ((E(), i.src)) {
            ...
            if (s.length) {
              ...
              r &&
                ...
                (D = s.after(C).detach().removeClass(S))),
